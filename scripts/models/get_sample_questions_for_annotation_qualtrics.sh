...
python get_sample_questions_for_annotation_qualtrics.py $TEST_DATA_FILE $TEXT_MODEL_DATA_FILE $READER_MODEL_DATA_FILE $READER_MODEL_FILE $OUT_DIR --filter_data_file $FILTER_DATA_FILE --text_model_file $TEXT_MODEL_FILE --reader_model_type $READER_MODEL_TYPE