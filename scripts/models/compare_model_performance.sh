...
MODEL_OUTPUT_FILES=(../../data/reddit_data/text_only_model/test_data_output_text.gz ../../data/reddit_data/author_text_data/test_data_output_text.gz ../../data/reddit_data/author_text_data/author_attention_data/test_data_output_text.gz)
#MODEL_NAMES=("text" "reader_token" "reader_attention" "reader_subreddit_embed" "reader_text_embed")
MODEL_NAMES=("text" "reader_token" "reader_attention")
